...
@JsonPropertyOrder({ "owner_auths" })
public class FindOwnerHistoriesReturn {

	@JsonProperty("owner_auths")
	private List<Object> ownerAuths = null;

	@JsonProperty("owner_auths")
	public List<Object> getOwnerAuths() {
		return ownerAuths;
	}

	@JsonProperty("owner_auths")
	public void setOwnerAuths(List<Object> ownerAuths) {
		this.ownerAuths = ownerAuths;
	}
